...
**One-command lifecycle (recommended):** keep the prebuilt images cached on disk and
...
once from the GitHub Release if it is missing.

Manual commands — the whole stack needs only **~3 GB images + ~1 GB data**. Everything else is reclaimable.
